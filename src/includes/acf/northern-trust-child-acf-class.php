...
acf_add_local_field_group(array(
	'key' => 'group_5ded8f36a1562',
	'title' => 'Event Details',
	'fields' => array(
		array(
			'key' => 'field_5ded8f4a80c9d',
			'label' => 'Start Date',
			'name' => 'start_date',
			'type' => 'date_time_picker',
			'instructions' => 'Select the date and time for this event.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			...
			'layouts' => array(
				...
				'layout_5ded908080ca0' => array(
					'key' => 'layout_5ded908080ca0',
					'name' => 'video',
					'label' => 'Video',
					'display' => 'block',
					'sub_fields' => array(
						array(
							'key' => 'field_5ded908080ca1',
							'label' => 'Video ID',
							'name' => 'video_id',
							'type' => 'text',
							'instructions' => 'Enter a video ID from You Tube.',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array(
								'width' => '',
			...
			'button_label' => 'Add Presentation',
			'min' => 0,
			'max' => 1,
		),
		array(
			'key' => 'field_5ded914cf9d80',
			'label' => 'Agenda',
			'name' => 'agenda',
			'type' => 'flexible_content',
			'instructions' => '',
...
acf_add_local_field_group(array(
	...
	'fields' => array(
		array(
			'key' => 'field_5e3b1124da739',
			'label' => 'Content',
			'name' => 'content',
			'type' => 'group',
			'instructions' => 'Enter the content to appear on the main square on the idle page.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_5e3ed6008e8c3',
			'label' => 'Weather',
			'name' => 'weather',
			'type' => 'group',
			'instructions' => 'We use openweathermap.org to pull the weather data in real time. In order to display weather data we need an API key from openweathermap.org and a zip code.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
			...
			'sub_fields' => array(
				array(
					...
					'default_value' => '',
					'placeholder' => '051329b7a4a6b550b878252d0cc7f247',
					'prepend' => '',
					'append' => '',
					'maxlength' => '',
				),
				array(
					'key' => 'field_5e3ed7228e8c5',
					'label' => 'Zip Code',
					'name' => 'zip_code',
					'type' => 'text',
					'instructions' => '',
